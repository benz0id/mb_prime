...
from src.seq_alignment_analyser.best_primers import reverse_inds, \
    BindingPairParams
import src.config_handling.formatting as fmt
...
class PrimerPartsManager:
    ...
    """
    _fivep_seqs: List[fmt.SeqPairParam]
    _binding_pair_pool: List[BindingPair]
    _msa_to_target: Dict[MSA, List[fmt.TargetRegionInfo]]

    def __init__(self, _fivep_seqs: List[fmt.SeqPairParam],
