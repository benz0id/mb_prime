...
from src.config_handling import input_validator as iv

from src.config_handling.input_validator import Validation
...
def menu(options: List[str], title: str, instructions: str) -> int:
    ...
    inp = prompt(instructions, [iv.VALID_INT, valid])
