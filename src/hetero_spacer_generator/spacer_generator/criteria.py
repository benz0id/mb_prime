...
import abc
from src.hetero_spacer_generator.defaults import CONSEC_WEIGHT, TOTAL_WEIGHT
...
from src.hetero_spacer_generator.sequence_tools import SeqAnalyzer, get_p3_adapter_int
