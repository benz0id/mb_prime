...
class HeteroGen:
    ...
    def generate_hetero_seq(self, primer: Seq, vary_len: int,
    ...
    def align_hetero(self, seq: Seq) -> List[Tuple[int]]:
        ...
        for i in range(0, self._num_hetero):
            ...
            spacers = [i]
            self.build_spacer_tree(seq, spacers, 4,
                                   spacer_combo_list=valid_spacer_combos)
        return valid_spacer_combos

    def build_spacer_tree(self, seq: Seq, spacers: List[int], target_depth: int,
                          depth: int = 0,
    ...
    def is_compatible_spacer(self, seq: Seq, spacers: List[int],
                             spacer: int, ) -> bool:
    ...
    def get_compatible_spacers(self, seq: Seq,
        ...
        for i in range(start_point, self._max_spacer_length):
            if self.is_compatible_spacer(seq, seqs_spacers, i):
